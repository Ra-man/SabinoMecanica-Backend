...
public class ClienteController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<Cliente> buscarPorCpf(@PathVariable int id) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Cliente> atualizar(@PathVariable int id, @RequestBody Cliente clienteDetalhes) {
