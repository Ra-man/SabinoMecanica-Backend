...
public class MovtoEntradaController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<MovtoEntrada> buscarPorId(@PathVariable Integer id) { // Alterado
    ...
    @PutMapping("/{id}")
    public ResponseEntity<?> atualizar(@PathVariable Integer id, @RequestBody MovtoEntrada movimentoDetalhes) { // Alterado
